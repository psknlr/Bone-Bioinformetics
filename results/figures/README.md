...
Binary figure files are intentionally not committed because this repository/PR workflow does not support binary artifacts.

Regenerate all figure PNGs locally with:
